        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < locations.Length; i++)
            {
                ...
                for (int x = 0; x < locations.Length; x++)
                {
                    ...
                    double distanceBetweenTwoTacoBells = corA.GetDistanceTo(corB);

                    if (distanceBetweenTwoTacoBells > distance)
                    {
                        distance = distanceBetweenTwoTacoBells;
                        tb1 = locA;
                        tb2 = locB;
                    }
                }
            ...
            Console.WriteLine($"{tb1.Name} and {tb2.Name} are the two Taco Bells farthest apart from each other");
